...
// Enhanced Reports Controller (to be implemented)
import { EnhancedReportController } from '../controllers/enhanced-report.controller';
...
router.get(
  ...
  EnhancedReportController.getEnhancedSummaryReport,
);
...
router.get(
  '/enhanced-detailed',
  validate(detailedReportSchema),
  EnhancedReportController.getEnhancedDetailedReport,
);
...
router.get(
  ...
  EnhancedReportController.getEnhancedVendorReport,
);
...
router.get(
  '/enhanced-plants',
  validate(plantReportSchema),
  EnhancedReportController.getEnhancedPlantReport,
);
...
router.get(
  ...
  EnhancedReportController.exportEnhancedReport,
);
